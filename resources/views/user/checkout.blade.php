                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" value="" placeholder="" id="billing_first_name" name="fname" class="input-text ">
                                            </p>
                                            ...
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                                ...
                                                <input type="text" value="" placeholder="" id="billing_company" name="cname" class="input-text ">
                                            </p>

                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                <label class="" for="billing_address_1">Address <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Street address" id="billing_address_1" name="add1" class="input-text ">
                                            </p>

                                            <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                                <input type="text" value="" placeholder="Apartment, suite, unit etc. (optional)" id="billing_address_2" name="add2" class="input-text ">
                                            </p>
                                            ...
                                            <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                ...
                                                <input type="text" value="" placeholder="Postcode / Zip" id="billing_postcode" name="pcode" class="input-text ">
                                            </p>
                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <input type="submit" data-value="Place order" value="Done Order" id="place_order" name="order" class="button alt">

                                            <input type="submit" data-value="Place order" value="Get Bill/Reciept" id="place_order" name="pdf" class="button alt">
